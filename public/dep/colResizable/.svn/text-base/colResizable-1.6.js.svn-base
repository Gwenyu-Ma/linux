...
(function($){ 	
    ...
    h.append("<style type='text/css'>  .JColResizer{table-layout:fixed;} .JColResizer > tbody > tr > td, .JColResizer > tbody > tr > th{overflow:hidden;padding-left:0!important; padding-right:0!important;}  .JCLRgrips{ height:0px; /*position:relative;*/ position:absolute;top:0;left:0;} .JCLRgrip{margin-left:-5px; position:absolute; z-index:5; } .JCLRgrip .JColResizer{position:absolute;background-color:red;filter:alpha(opacity=1);opacity:0;width:10px;height:100%;cursor: e-resize;top:0px} .JCLRLastGrip{position:absolute; width:1px; } .JCLRgripDrag{ border-left:1px dotted black;	} .JCLRFlex{/*width:auto!important;*/} .JCLRgrip.JCLRdisabledGrip .JColResizer{cursor:default; display:none;}</style>");
	...
	var init = function( tb, options){	
        ...
        if(t.opt.onResize){
            t.on('resize.refreCol',t.opt.onResize);
        }
	...
	var syncGrips = function (t){	
		...
		for(var i=0; i<t.ln; i++){	//for each column
			var c = t.c[i];
            //console.log(i,c.offset().left,t.offset().left,c.outerWidth(false),t.cs / 2); 			
